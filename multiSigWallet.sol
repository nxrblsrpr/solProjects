...
//Revisit and attempt to re-write for mastery (If you can understand this contract inside & out, consider that to be a milestone for an intermediate level of understanding for the Solidity language)
